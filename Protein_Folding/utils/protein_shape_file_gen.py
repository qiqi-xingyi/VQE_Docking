...
import numpy as np
from Protein_Folding.peptide import Peptide
...
class ProteinShapeFileGen:
    ...
    def save_xyz_file(
        ...
        """
        Saves the PDBbind_data as an .xyz file.
        For more information about .xyz process_data see:
        https://en.wikipedia.org/wiki/XYZ_file_format.

        Args:
            name: The file will be called `"name".xyz`. Can overwrite process_data.
