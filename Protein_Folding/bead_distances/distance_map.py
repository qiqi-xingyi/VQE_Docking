...
from ..peptide.pauli_ops_builder import _build_full_identity #mark
...
class DistanceMap:
    ...
    def __getitem__(self, position: Tuple[BaseBead, BaseBead]) -> Operator:
    ...
    @property
    def distance_map(self) -> DefaultDict[BaseBead, Dict[BaseBead, Operator]]:
